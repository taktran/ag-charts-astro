...
<ChartExampleRunner title='Zoom' name='zoom' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Enabling and Disabling Features' name='zoom-selecting' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Axes' name='zoom-axes' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Scrolling Pivot' name='zoom-scrolling-pivot' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Scrolling Step' name='zoom-scrolling-step' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Min Ratio' name='zoom-min-ratio' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Pan Key' name='zoom-pan-key' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
...
<ChartExampleRunner title='Zoom Context Menu' name='zoom-context-menu' type='generated' options='{ "enterprise": true }'></ChartExampleRunner>
