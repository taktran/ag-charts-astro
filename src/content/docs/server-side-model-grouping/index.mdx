...
<GridExampleRunner title='Row Grouping' name='row-grouping' type='generated' options='{ "enterprise": true, "exampleHeight": 590, "extras": ["alasql"], "modules": ["serverside", "rowgrouping"] }'></GridExampleRunner>
...
<GridExampleRunner title='Open by Default' name='open-by-default' type='generated' options='{ "enterprise": true, "extras": ["alasql"], "modules": ["serverside"] }'></GridExampleRunner>
...
<GridExampleRunner title='Sticky Groups' name='suppress-sticky-groups' type='generated' options='{ "enterprise": true, "extras": ["alasql"], "modules": ["serverside"] }'></GridExampleRunner>
...
<GridExampleRunner title='Group Footers' name='group-footer' type='generated' options='{ "enterprise": true, "extras": ["alasql"], "modules": ["serverside"] }'></GridExampleRunner>

Row group footers can also be used with `groupDisplayType='multipleColumns`, as demonstrated in the example below.

<GridExampleRunner title='Multiple Group Columns and Footers' name='group-footer-multiple-cols' type='generated' options='{ "enterprise": true, "extras": ["alasql"], "modules": ["serverside"] }'></GridExampleRunner>
...
<GridExampleRunner title='Expand All' name='expand-all' type='generated' options='{ "enterprise": true, "extras": ["alasql"], "modules": ["serverside"] }'></GridExampleRunner>
...
<GridExampleRunner title='Child Counts' name='child-counts' type='generated' options='{ "enterprise": true, "exampleHeight": 590, "extras": ["alasql"], "modules": ["serverside"] }'></GridExampleRunner>
...
<GridExampleRunner title='Complex Objects' name='complex-objects' type='generated' options='{ "enterprise": true, "exampleHeight": 590, "extras": ["alasql"], "modules": ["serverside", "rowgrouping"] }'></GridExampleRunner>
...
<GridExampleRunner title='Filtering' name='filtering' type='generated' options='{ "enterprise": true, "exampleHeight": 590, "extras": ["alasql"], "modules": ["serverside", "rowgrouping"] }'></GridExampleRunner>
