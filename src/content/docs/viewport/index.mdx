...
<GridExampleRunner title='Viewport Example' name='viewport' type='generated' options='{ "enterprise": true, "modules":["viewport"] }'></GridExampleRunner>
...
<GridExampleRunner title='Pagination Viewport Example' name='pagination-viewport' type='generated' options='{ "enterprise": true, "modules":["viewport"], "exampleHeight": 570 }'></GridExampleRunner>
