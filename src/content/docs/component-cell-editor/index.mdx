...
<GridExampleRunner title='Simple Editor Components' name='component-editor' type='mixed' options='{ "exampleHeight": 370, "includeNgFormsModule" : true }'></GridExampleRunner>
...
<GridExampleRunner title='Simple Editor Components' name='component-editor-2' type='mixed' options='{ "enterprise": true, "modules": ["clientside", "richselect"], "exampleHeight": 370, "includeNgFormsModule" : true }'></GridExampleRunner>
...
<GridExampleRunner title='Get Editor Instance' name='get-editor-instance' type='mixed' options='{ }'></GridExampleRunner>
