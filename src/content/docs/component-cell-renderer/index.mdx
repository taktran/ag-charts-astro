...
<GridExampleRunner title='Simple Cell Renderer' name='simple' type='mixed' options='{ "exampleHeight": 460 }'></GridExampleRunner>
...
<GridExampleRunner title='Cell Renderer' name='cell-renderer' type='mixed'></GridExampleRunner>
...
<GridExampleRunner title='Group Renderers' name='custom-group-renderer' type='mixed' options='{"enterprise": true, "modules": ["clientside", "rowgrouping"]}'></GridExampleRunner>
...
<GridExampleRunner title='Get Cell Renderer' name='get-cell-renderer' type='generated'></GridExampleRunner>
...
<framework-specific-section frameworks="angular">
<GridExampleRunner title='Simple Dynamic Component' name='dynamic-components' type='mixed' options='{ "extras": ["fontawesome", "bootstrap"] }'></GridExampleRunner>
</framework-specific-section>
...
<framework-specific-section frameworks="angular">
<GridExampleRunner title='Richer Dynamic Components' name='angular-rich-dynamic' type='angular' options='{ "exampleHeight": 380, "extras": ["bootstrap"] }'></GridExampleRunner>
</framework-specific-section>
...
<GridExampleRunner title='Cell Renderer Keyboard Navigation' name='cell-renderer-keyboard-navigation' type='mixed'></GridExampleRunner>
