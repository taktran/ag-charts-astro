...
<GridExampleRunner title='Row Height Simple' name='row-height-simple' type='generated'></GridExampleRunner>
...
<GridExampleRunner title='Changing Row Height' name='row-height-change' type='generated' options=' { "enterprise": true, "exampleHeight": 590, "modules": ["clientside", "rowgrouping", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Row Height Complex' name='row-height-complex' type='generated'></GridExampleRunner>
...
<GridExampleRunner title='Auto Row Height' name='auto-row-height' type='generated' options=' { "enterprise": true, "modules": ["clientside", "rowgrouping", "menu", "columnpanel"] }'></GridExampleRunner>
