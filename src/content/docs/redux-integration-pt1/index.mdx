...
<GridExampleRunner title='Redux File View' name='redux-file-view' type='react' options=' { "enterprise": true, "showImportsDropdown": false, "extras": ["fontawesome"] }'></GridExampleRunner>
