...
<GridExampleRunner title='Single Row Selection' name='single-row-selection' type='generated'></GridExampleRunner>
...
<GridExampleRunner title='Multiple Row Selection' name='multiple-row-selection' type='generated'></GridExampleRunner>
...
<GridExampleRunner title='Multi Select With Click' name='multi-select-single-click' type='generated'></GridExampleRunner>
...
<GridExampleRunner title='Displaying Disabled Checkboxes' name='disabled-checkboxes' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Forcing Checkboxes As Selected' name='force-enable-checkboxes' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Groups & Checkbox Selection' name='group-selection' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Groups & Checkbox Selection With Unselectable Leaf Nodes' name='selection-checkbox' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Groups & Checkbox Selection With Only Filtered Children' name='selection-checkbox-filtered' type='generated' options='{ "enterprise": true, "exampleHeight": 590, "modules": ["clientside", "rowgrouping", "setfilter", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Just Filtered' name='header-checkbox' type='generated' options='{ "exampleHeight": 590 }'></GridExampleRunner>
...
<GridExampleRunner title='Select Everything' name='header-checkbox-entire-set' type='generated' options='{ "exampleHeight": 590 }'></GridExampleRunner>
...
<GridExampleRunner title='Selecting Current Page' name='header-checkbox-current-page' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping"] }'></GridExampleRunner>
...
<GridExampleRunner title='Selecting Current Page with Group Selects Children' name='header-checkbox-current-page-groups' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping"] }'></GridExampleRunner>
...
<GridExampleRunner title='Selectable Rows with Header Checkbox' name='specify-selectable-rows' type='generated' options='{ "enterprise": true, "modules": ["clientside", "rowgrouping"] }'></GridExampleRunner>
...
<GridExampleRunner title='Specifying Selectable Rows with Groups' name='specify-selectable-rows-with-groups' type='generated' options='{ "enterprise": true, "exampleHeight": 590, "modules": ["clientside", "rowgrouping", "setfilter", "menu", "columnpanel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Selection Events' name='selection-events' type='generated'></GridExampleRunner>
...
<GridExampleRunner title='Using forEachNode' name='using-foreachnode' type='generated' options='{ "exampleHeight": 590 }'></GridExampleRunner>
...
<GridExampleRunner title='Selection with Keyboard Arrow Keys' name='selection-with-arrow-keys' type='generated'></GridExampleRunner>
