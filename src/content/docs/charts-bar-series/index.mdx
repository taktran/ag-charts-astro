...
<ChartExampleRunner
  title="Grouped Stacks with a Shared Legend"
  name="grouped-stack-shared"
  type="generated"
></ChartExampleRunner>
...
<note>It's possible to use any non-zero value to normalize to.</note>

<ChartExampleRunner
  title="Normalized Column Series"
...
<ChartExampleRunner
  title="Column Series with Labels"
  name="labeled-column"
  type="generated"
></ChartExampleRunner>

<note>
  It's best to avoid using labels with grouped columns (or bars), because
  columns in grouped mode tend to be narrow and often won't fit a label.
</note>
