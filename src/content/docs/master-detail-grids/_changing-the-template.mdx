...
<framework-specific-section frameworks="javascript,angular,vue">
<GridExampleRunner title='Customising via String Template' name='string-template-customisation' type='generated' options='{ "enterprise": true, "exampleHeight": 550, "modules": ["clientside", "masterdetail", "menu", "columnpanel"] }'></GridExampleRunner>
</framework-specific-section>
...
<framework-specific-section frameworks="javascript,angular,vue">
<GridExampleRunner title='Customising via Template Callback' name='template-callback-customisation' type='generated' options='{ "enterprise": true, "exampleHeight": 550, "modules": ["clientside", "masterdetail", "menu", "columnpanel"] }'></GridExampleRunner>
</framework-specific-section>