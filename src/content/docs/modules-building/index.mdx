...
<framework-specific-section frameworks="frameworks">
<GridExampleRunner title='Using Modules' name='module-grid' type='multi' options='{ "enterprise": true, "modules": ["clientside", "menu", "excel"], "showCode": true }'></GridExampleRunner>
</framework-specific-section>
