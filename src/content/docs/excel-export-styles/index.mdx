...
<GridExampleRunner title='Excel Export - Styles' name='excel-export-with-styles' type='generated' options='{ "enterprise": true, "modules": ["clientside", "menu", "excel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Excel Export - Header Styles' name='excel-export-with-header-styles' type='generated' options='{ "enterprise": true, "modules": ["clientside", "menu", "excel"] }'></GridExampleRunner>
...
<GridExampleRunner title='Excel Export - Styling Row Groups' name='excel-export-styling-row-groups' type='generated' options='{  "enterprise": true, "modules": ["clientside", "menu", "excel", "rowgrouping"]}'></GridExampleRunner>
